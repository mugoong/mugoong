...
export default function ListingCard({ listing }: { listing: Listing }) {
  ...
  return (
    <Link
      ...
      className="group block overflow-hidden rounded-xl border border-gray-100 bg-white shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md"
    >
      {/* Image */}
      ...
      <div className="p-3">
        {/* Store name */}
        <h3 className="mb-1 line-clamp-1 text-sm font-semibold text-gray-900 transition-colors group-hover:text-primary-600">
          {listing.title}
        </h3>
        ...
        {/* Rating + Price — hidden for Tips & Trend */}
        {!isTips && (
